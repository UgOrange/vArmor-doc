...
Please refer to this [document](https://github.com/opencontainers/runtime-spec/blob/main/config-linux.md#seccomp) to set custom syscalls blocklist rules in the [`.spec.policy.enhanceProtect.syscallRawRules`](../../getting_started/interface_specification) field.
...
Please refer to the syntaxes below to set custom file and network rules in the [`.spec.policy.enhanceProtect.bpfRawRules`](../../getting_started/interface_specification#bpfrawrules) field.
...
* Please refer to [NetworkEgressRule](../../getting_started/interface_specification#networkegressrule) for specific details.
